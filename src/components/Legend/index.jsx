...
export function Legend({ layer }) {
    ...
    return (<div className={styles.legend}>
        ...
        <img src={`https://geoserver.monitoraea.org.br/geoserver/pppzcm/wms?REQUEST=GetLegendGraphic&VERSION=1.0.0&FORMAT=image/png&WIDTH=20&HEIGHT=20&LEGEND_OPTIONS=dpi:100;columns:1&LAYER=${layer}`} />
    </div>)
}
