...
function Single({ staleTime = 3600000 /* 1h */ }) {
  ...
  useEffect(() => {
    async function fetchData() {
      ...
      const {
        ...
        `${import.meta.env.VITE_SERVER}iniciativa/${params.id}/atuacoes`,
      );
  ...
  const mutations = {
    send: useMutation(() =>
      axios.post(
        `${import.meta.env.VITE_SERVER}iniciativa/${params.id}/send_contact`,
        { email, name, message },
      ),
    ),
  };
        ...
        <div className="width-limiter">
          <div className={styles.content}>
            ...
            <div className={styles["button-wrapper"]}>
              <button
                onClick={() =>
                  (window.location = `${import.meta.env.VITE_PPZCM_URL}colabora/participate/iniciativa/${params.id}`)
                }
              >
