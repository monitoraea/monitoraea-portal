...
import vladimir from "../../images/pppzcm/comite/people/vladimir.png";
  ...
  const { data: facilitators } = useQuery(
    ["facilitators", { uf_selected: uf_selected?.label }],
    {
      queryFn: async () =>
        (
          await axios.get(
            `${import.meta.env.VITE_SERVER}project/facilitators/?${uf_selected && uf_selected.value !== "-1" ? `&uf=${uf_selected.value}` : ""}`,
          )
        ).data,
      staleTime: 3600000,
    },
        ...
        <div className="width-limiter">
          <div className={styles.about}>
            ...
            <div className={styles.text}>
              <div>
                O Projeto Político Pedagógico da Zona Costeira e Marinha do
                Brasil (PPPZCM) é um instrumento de gestão de processos
              ...
              <div>
                <div className={styles["button-wrapper"]}>
                  <button
                    onClick={() =>
                      (window.location.href = "/colabora/minha_area")
                    }
                  >
        ...
        <div className={styles.inner}>
          <div className="width-limiter">
            ...
            <div className={styles.box}>
              A missão do Projeto Político Pedagógico da Zona Costeira e Marinha
              do Brasil (PPPZCM) é ser um instrumento político-pedagógico
              dinâmico, vivo, emancipatório, crítico, científico e popular - de
              gestão de processos educativos com foco no uso sustentável e
      ...
      <div className={`${styles["more-content"]} ${styles["type2"]}`}>
        <div className={styles.inner}>
          <div className="width-limiter">
            ...
            <div className={styles.texto}>
              Lançada em 2021, a Rede de Comunidades de Aprendizagens do PPPZCM
              se alinha às estruturas de redes horizontais e informais pautadas
              na confiança e cooperação entre seus elos e com objetivos comuns
              de desenvolver processos críticos e estruturantes de capacitação e
              educação ambiental que contribuam para o uso sustentável e
              conservação da biodiversidade da ZCM.
            </div>
            ...
            <div className={styles.texto}>
              <div>
                ...
                <p>
                  <span>Elos da Rede:</span> Todas as pessoas e organizações que
                  alinharam suas iniciativas às diretrizes do PPPZCM e
                  registraram suas ações na Plataforma MonitoraEA-PPPZCM.
                </p>

                <p>
                  <span>Grupo de Facilitação da Rede:</span> Cerca de 50 pessoas
                  (organizações/pessoas) participantes diretamente da gestão e
                  governança do PPPZCM junto ao Comitê Gestor. Atuam no
                  enraizamento e capilaridade da rede nos territórios.
                </p>

                <p>
                  <span>Comitê Gestor da Rede:</span> Instituições que atuam na
                  gestão e governança da rede.
                </p>
              </div>
              <div>
                <div className={styles.image}>
            ...
            <div className={styles.box}>
              A Rede objetiva ser um espaço e movimento de conexões, diálogos,
              cooperação, articulações, formação, autoformação, monitoramento e
              avaliação, promovendo o fortalecimento e a incidência em políticas
              públicas, bem como promover a governança da implementação do
              Projeto Político Pedagógico da Zona Costeira e Marinha; e
              contribuir para materializar as diretrizes e objetivos do PPPZCM.
            </div>
          </div>
        </div>
      </div>
        ...
        <div className={styles.inner}>
          <div className="width-limiter">
            ...
            <div className={styles.texto}>
              <div>
                <div>
                  O Comitê Gestor atua na estruturação, fortalecimento e
                  consolidação da Rede de Comunidades de Aprendizagens do PPPZCM
                  e desenvolve processos metodológicos formativos e de
                  co-criação diretamente junto ao grupo de facilitação da Rede.
                </div>
              </div>
            </div>
            ...
            <div className={styles.people}>
              ...
              <div className={styles.person}>
                ...
                <div className={styles.info}>
                  <div>Thais Ferraresi Pereira</div>
                  <div>DEA/MMA</div>
              ...
              <div className={styles.person}>
                ...
                <div className={styles.info}>
                  <div>Vladimir Andrade Nobrega</div>
                  <div>Cenea/IBAMA</div>
                  <div>acvladi@gmail.com</div>
                  <div>DF</div>
                </div>
              </div>
              ...
              <div className={styles.person}>
                ...
                <div className={styles.info}>
                  <div>Ana Rosa Marques</div>
                  <div>CIPEA/DITEC/EEA/IBAMA/MA</div>
                  <div>anclaros46@gmail.com</div>
                  <div>MA</div>
                </div>
              </div>
              ...
              <div className={styles.person}>
                ...
                <div className={styles.info}>
                  <div>Nadja Janke</div>
                  <div>DEA/MMA</div>
                  <div>nadja.janke@mma.gov.br</div>
                  <div>DF</div>
                </div>
              </div>
              ...
              <div className={styles.person}>
                ...
                <div className={styles.info}>
                  <div>Patricia Fernandes Barbosa</div>
                  <div>DEA/MMA</div>
                  <div>patricia32fb@gmail.com</div>
                  <div>DF</div>
                </div>
              </div>
            </div>
        ...
        <div className={styles.inner}>
          <div className="width-limiter">
            ...
            <div className={styles.texto}>
              <div>
                <div>
                  Os facilitadores atuam na materialização das diretrizes,
                  missão e objetivos do PPPZCM nos territórios da Zona Costeira
                  e Marinha do Brasil e na gestão e governança da implementação
                  do PPPZCM, a partir de processos de formação, mobilização,
                  articulação, educomunicação e planejamento, em articulação com
                  os demais Elos da Rede. Encontre o facilitador mais próximo de
                  você e entre em contato.
                </div>
              </div>
              <div>
                <div className={styles.assista}>
            ...
            <div className={styles.facilitadores}>
              <div className={styles.people}>
                {facilitators &&
                  facilitators.map((f) => (
                    <div key={f.id} className={styles.person}>
                      <div className={styles.photo}>
                        <img src={f.photo || mock_photo} />
                      </div>
                      <div className={styles.info}>
                        <div>{f.name}</div>
