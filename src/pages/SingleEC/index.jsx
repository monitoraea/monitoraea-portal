        ...
        <div className="width-limiter">
          <div className={styles.content}>
            <div>
              ...
              {data?.nivel_name?.length && <div className={styles.modal}>
                <span>Nível</span> <span>
                  {data?.nivel_name.join(', ')}
                </span>
              </div>}
            </div>
      ...
      <div className={`${styles.section} ${styles.titled}`}>
        <div className="width-limiter">
          <div className={styles.content}>
            ...
            <div className={styles.text}>{data.temas}</div>
          </div>
        </div>
      </div>
        ...
        <div className="width-limiter">
          <div className={styles.content}>
            ...
            <div className={styles.text}>
              {data.redes_sociais && (
                <>
                  {/* <a href={data.redes_sociais} target="_blank">
