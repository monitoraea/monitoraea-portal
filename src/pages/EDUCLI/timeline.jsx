...
export default function Timeline({ staleTime = 3600000, /* 1h */ }) {
    const { data } = useQuery(['educom-timeline'], {
        queryFn: async () => (await axios.get(`${import.meta.env.VITE_SERVER}educom_clima/timeline`)).data,
        staleTime,
    });
    ...
    return (<section id="monitoraea_midia">
        ...
        {data && <div className="width-limiter">
            ...
            <div className="inner-title-box na-midia">
                <div className="left-side">Linha do tempo</div>
