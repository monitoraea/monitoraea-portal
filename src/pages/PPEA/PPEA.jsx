            ...
            <div className={styles.content}>
              ...
              <div>
                <p>
                  ...
                  resolução de um problema público comum que deve ser enfrentado
                  pela coletividade.
                </p>
                <p>
                  Nesta abordagem, o ator protagonista de uma política pública
                  pode ser tanto o <span>governo</span>, como a{" "}
                  <span>sociedade civil</span> ou <span>setor privado</span> que
                  juntos formulam e implementam políticas públicas defendendo o
                  que traz benefícios para todos sem excluir ninguém.
                </p>

                <p>
                  Com essa abordagem de políticas públicas são considerados os
                  diversos centros de tomadas de decisão capilarizados nos
                  territórios, no entanto, os atores são interdependentes já que
                  nenhum deles possui recursos ou autoridade por completo para
                  resolver sozinho o problema público.
                </p>
                <p>
                  É preciso <span>diálogo e cooperação em rede</span> o que exige
                  o desafio da coordenação entre os participantes e governança
      ...
      <div className={styles["diagrams"]}>
        <div className={styles.d3}>
          <div className={styles['width-limiter']}>
            ...
            {isMobile && <div className={styles.dimensoes}>
              <div className={styles.dimensao}>
                <div className={styles.title}>Dimensão Diagnóstica</div>
                <div className={styles.indicador}><div>01.</div><div>Realização de diagnóstico participativo</div></div>
              </div>

              <div className={styles.dimensao}>
                <div className={styles.title}>Dimensão de Governança Participativa e Adaptativa</div>
                <div className={styles.indicador}><div>02.</div><div>Mobilização Social</div></div>
                <div className={styles.indicador}><div>03.</div><div>Instâncias e/ou colegiados para diálogos, construção e tomadas de decisão coletiva</div></div>
                <div className={styles.indicador}><div>04.</div><div>Transparência</div></div>
                <div className={styles.indicador}><div>05.</div><div>Mecanismos para lidar com a imprevisibilidade</div></div>
                <div className={styles.indicador}><div>06.</div><div>Instrumento pedagógico participativo</div></div>
                <div className={styles.indicador}><div>07.</div><div>Monitoramento e Avaliação</div></div>
              </div>

              <div className={styles.dimensao}>
                <div className={styles.title}>Dimensão da Formação Dialógica</div>
                <div className={styles.indicador}><div>08.</div><div>Desenvolvimento do processo formativo</div></div>
                <div className={styles.indicador}><div>09.</div><div>Diversidade de públicos envolvidos</div></div>
                <div className={styles.indicador}><div>10.</div><div>Educadores ambientais formados</div></div>
              </div>

              <div className={styles.dimensao}>
                <div className={styles.title}>Dimensão da Subjetividade do Indivíduo</div>
                <div className={styles.indicador}><div>11.</div><div>Elevação da autoestima</div></div>
                <div className={styles.indicador}><div>12.</div><div>Laços e vínvulos comunitários e sociais</div></div>
                <div className={styles.indicador}><div>13.</div><div>Ações educativas ambientais articuladas com os aspectos culturais</div></div>
              </div>

              <div className={styles.dimensao}>
                <div className={styles.title}>Dimensão da Intervenção Socioambiental</div>
                <div className={styles.indicador}><div>14.</div><div>Intervenções socioambientais geradas</div></div>
              </div>

              <div className={styles.dimensao}>
                <div className={styles.title}>Dimensão da Complexidade</div>
                <div className={styles.indicador}><div>15.</div><div>Articulação temática</div></div>
                <div className={styles.indicador}><div>16.</div><div>Articulação de redes, movimentos e coletivos</div></div>
                <div className={styles.indicador}><div>17.</div><div>Conexão com referências e documentos internacionais</div></div>
                <div className={styles.indicador}><div>18.</div><div>Ações afirmativas</div></div>
              </div>
              <div className={styles.dimensao}>
                <div className={styles.title}>Dimensão Institucional</div>
                <div className={styles.indicador}><div>19.</div><div>Instrumento legal</div></div>
                <div className={styles.indicador}><div>20.</div><div>Gestão racional dos bens naturais, patrimoniais e públicos</div></div>
                <div className={styles.indicador}><div>21.</div><div>Suporte orçamentário</div></div>
                <div className={styles.indicador}><div>22.</div><div>Nível da PPEA na estrutura organizacional/administrativa</div></div>
              </div>

              <div className={styles.dimensao}>
                <div className={styles.title}>Dimensão da Comunicação</div>
                <div className={styles.indicador}><div>23.</div><div>Plano e ferramentas de comunicação</div></div>
                <div className={styles.indicador}><div>24.</div><div>Educomunicação / Comunicação Social</div></div>
              </div>
